let turno=0;
const tablero = [];
//el const de abajo es para ambair de color cuando hagan click en un boton
...
//cuando apreto en cualquier button(hago un forEacho xq la funcion querySelectorAll me devuelve un array)
